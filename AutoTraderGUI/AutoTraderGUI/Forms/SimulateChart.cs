...
namespace AutoTraderGUI.Forms
{
    public partial class SimulateChart : UserControl
    {
        ...
        public SimulateChart()
        {
            ...
            EvaluationChart.ChartAreas[0].AxisY.LabelStyle.Format = "{0:D5}";
            ...
            YieldChart.ChartAreas[0].AxisY.LabelStyle.Format = "{0:00.0#}";
            ...
            DistChart.ChartAreas[0].AxisY.LabelStyle.Format = "{0:D5}";
            ...
            MDDChart.ChartAreas[0].AxisY.LabelStyle.Format = "{0:00.0#}";
            ...
            ProfitLossChart.ChartAreas[0].AxisY.LabelStyle.Format = "{0:D4}";
            ...
            MFEMAEChart.ChartAreas[0].AxisY.LabelStyle.Format = "{0:00.0#}";
        }
